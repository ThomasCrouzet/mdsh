...
export const fr: Record<MessageKey, string> = {
	...
	'library.repairHint':
		'Ouvrez le document qui contient le lien pour vérifier sa cible. Les 200 premiers liens sont affichés.',
	'pwa.ready': 'Prêt hors ligne',
	'pwa.preparing': 'Préparation du mode hors ligne...',
	'pwa.unavailable': 'Cache hors ligne indisponible',
	'templates.manage': 'Gérer les modèles',
	'templates.help':
		'Enregistrez un document comme modèle depuis les commandes. {{date}} insère la date locale du jour.',
	'templates.name': 'Nom du modèle',
	'templates.content': 'Contenu Markdown',
	...
	'templates.none': 'Aucun modèle personnel pour le moment.',
	'templates.meeting': 'Compte rendu de réunion',
	'templates.journal': 'Journal quotidien',
	'templates.todo': 'Liste de tâches',
	'templates.meetingDescription': 'Ordre du jour, décisions et actions',
	'templates.journalDescription': 'Une entrée datée pour aujourd’hui',
	'templates.todoDescription': 'Une liste de cases à cocher',
	'navigation.outline': 'Plan du document',
	'navigation.find': 'Rechercher dans ce document',
	'navigation.previous': 'Résultat précédent',
	'navigation.next': 'Résultat suivant',
	'navigation.close': 'Fermer la navigation du document',
	'navigation.empty': 'Ajoutez un titre pour naviguer dans ce document.',
	'statusBar.local': 'Brouillons locaux : {state}',
	'statusBar.diskManual': 'Enregistrement disque manuel',
	'statusBar.backupDue': 'Sauvegarder vos documents',
	'statusBar.dismissReminder': 'Me rappeler la sauvegarde la semaine prochaine',
	'settings.backupSummary':
		'Sauvegarde du {date} : {drafts} document(s), {workspaces} espace(s) de travail, {templates} modèle(s).',
	'settings.verifyBackup': 'Vérifier une sauvegarde...',
	'settings.backupValid': 'Sauvegarde vérifiée. Votre bibliothèque est inchangée.',
	'settings.backupDownloadHint':
		'Conservez le fichier exporté hors de ce navigateur. Vérifiez-le ici avant de devoir le restaurer. Le téléchargement doit être terminé pour que la copie soit disponible.',
	'settings.about': 'À propos de mdsh',
	'settings.userGuide': 'Guide utilisateur (nouvel onglet)',
	'actions.title': 'Actions',
	'actions.commands': 'Commandes et raccourcis',
	'actions.allCommands': 'Toutes les commandes et les raccourcis clavier',
	'actions.documents': 'Documents',
	'actions.export': 'Enregistrer et exporter',
	'actions.workspace': 'Espace de travail',
	'actions.backups': 'Sauvegardes et restauration',
	'files.nameExists': 'Un document nommé « {name} » existe déjà. Choisissez un autre nom.',
	'files.linksUpdated': 'Liens mis à jour dans {n} document(s).',
	'files.ambiguousLink':
		'Plusieurs documents correspondent à « {name} ». Ouvrez la bibliothèque pour choisir le document.',
	'library.title': 'Bibliothèque de documents',
	'library.scope': 'Rechercher dans',
	'library.all': 'Tous les documents',
	'library.open': 'Onglets ouverts',
	'library.closed': 'Documents fermés',
	...
	'palette.exportAll': 'Exporter tous les fichiers (ZIP)',
